...
from Lab3_part1 import Lab3_part1  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = qtgui.Range(300, 390.625e3, 100, 1e3, 200)
        ...
        self._Ka_range = qtgui.Range(-2, 2, 0.1, 1, 200)
        ...
        self._Am_win = qtgui.RangeWidget(self._Am_range, self.set_Am, "Amplitude de mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Am_win)
        self._Ac_range = qtgui.Range(0, 1, 1e-3, 125e-3, 200)
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "Amplitud de la portadora (Ac)", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        # Connections
        ##################################################
        self.connect((self.Lab3_part1_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Lab3_part1_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Lab3_part1_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Lab3_part1_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Lab3_part1_0.set_ka(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Lab3_part1_0.set_Ac(self.Ac)
