...
class LAb_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._offset_range = qtgui.Range(-5, 5, 1e-3, 0, 200)
        ...
        self._amplitude_range = qtgui.Range(0, 5, 1e-3, 1, 200)
        self._amplitude_win = qtgui.RangeWidget(self._amplitude_range, self.set_amplitude, "Amplitude", "counter", float, QtCore.Qt.Horizontal)
