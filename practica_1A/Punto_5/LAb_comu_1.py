...
# Title: Dem teroema Nyquist
# Author: Jose_Barrios_Sergio_Velez_BIC_G4
...
class LAb_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Dem teroema Nyquist", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dem teroema Nyquist")
